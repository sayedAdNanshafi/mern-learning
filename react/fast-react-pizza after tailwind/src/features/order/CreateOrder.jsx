...
export async function action({ request }) {
  ...
  // do not overuse this i,e do not import store directly into another page. it deactivates some performance optimization techniques that redux uses on that page
